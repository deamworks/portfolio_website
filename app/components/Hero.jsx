  ...
  return (
    ...
    <section className="my-12 pb-8" id='home'>
        ...
        className='flex flex-col md:flex-row items-center gap-4 w-full md:w-auto'>
            ...
            <a 
              href="assets/Resume Putita Chaleeprom (2).pdf" download className='w-full md:w-auto py-3 px-8 rounded-full font-semibold border border-content/20 hover:border-content/40 hover:shadow-sm transition-colors duration-300 flex items-center justify-center gap-2'>
